var upsertTeam = function () {
    ...
    var upsertTeamForm = function () {
        $("#upsertTeamForm").validate({
    ...
    var submitTeamForm = function (f, formData) {
        $.ajax({
            type: f[0].method,
            url: f[0].action,
            data: formData,
            ...
            success: function (data, strStatus) {
                if (IsNewSave == 1) {
                    ...
                    window.location.href = "/Team/Upsert";
                }
                else {
                    showMessage(data.Message, data.Data, data.Type);
                    window.location.href = "/Team/Upsert/" + data.OptionalValue;
                }
            },
